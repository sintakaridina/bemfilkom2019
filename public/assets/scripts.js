...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 100) {
            ...
            logo.attr('src', 'img/logobem.png');
            darkbg.attr('src', 'img/logobem.png');
            whitebg.attr('src', 'img/logobem.png');
            scrollbg.attr('src', 'img/logobem.png');
            lightbg.attr('src', 'img/logobem.png');
        } else {
            navbar.removeClass("nav-scroll");
            logo.attr('src', 'img/logobem.png');
            lightbg.attr('src', 'img/logobem.png');
            navbloglogo.attr('src', 'img/logobem.png');
        }
    });
